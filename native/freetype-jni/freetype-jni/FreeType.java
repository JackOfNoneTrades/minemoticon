...
//	public static native SubGlyph FT_Get_SubGlyph_Info				(long glyphSlot, int subIndex);
	...
	// ---- Color palette (COLRv1)
	public static native boolean FT_Palette_Select                 (long face, int paletteIndex);
	public static native int     FT_Face_Get_num_palettes          (long face);
	...
	// Native library loading is handled externally by the caller (FreeTypeRenderer).
	// No static initializer -- the caller must System.load() before using this class.
}