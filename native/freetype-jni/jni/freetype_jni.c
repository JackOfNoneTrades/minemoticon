...
/* --- FreeType functions --- */
JNIEXPORT jobject JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Library_1Version(JNIEnv *env, jclass obj, jlong library) {
...
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Done_1FreeType(JNIEnv *env, jclass obj, jlong lib) {
...
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Set_1Pixel_1Sizes(JNIEnv *env, jclass obj, jlong face, jfloat width, jfloat heigth) {
	return FT_Set_Pixel_Sizes((FT_Face)face, width, heigth);
}

JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Load_1Char(JNIEnv *env, jclass obj, jlong face, jchar c, jint flags) {
	return FT_Load_Char((FT_Face)face, c, flags);
}

JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Done_1Face(JNIEnv *env, jclass obj, jlong face) {
	return FT_Done_Face((FT_Face)face);
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1ascender(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->ascender;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1descender(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->descender;
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1face_1flags(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->face_flags;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1face_1index(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1max_1advance_1height(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->max_advance_height;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1max_1advance_1width(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->max_advance_width;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1num_1faces(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->num_faces;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1num_1glyphs(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->num_glyphs;
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1style_1flags(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1underline_1thickness(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->underline_thickness;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1units_1per_1EM(JNIEnv *env, jclass obj, jlong face) {
	return ((FT_Face)face)->units_per_EM;
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1size(JNIEnv *env, jclass obj, jlong face) {
	return (jlong)(((FT_Face)face)->size);
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Get_1metrics(JNIEnv *env, jclass obj, jlong size) {
	return (jlong)&(((FT_Size)size)->metrics);
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1ascender(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->ascender;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1descender(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->descender;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1height(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->height;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1max_1advance(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->max_advance;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1x_1ppem(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->x_ppem;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1x_1scale(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->x_scale;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1y_1ppem(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->y_ppem;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Size_1Metrics_1Get_1y_1scale(JNIEnv *env, jclass obj, jlong sizeMetrics) {
	return ((FT_Size_Metrics*)sizeMetrics)->y_scale;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Get_1Char_1Index(JNIEnv *env, jclass obj, jlong face, jint code) {
	return FT_Get_Char_Index((FT_Face)face, code);
}
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1HAS_1KERNING(JNIEnv *env, jclass obj, jlong face) {
	return FT_HAS_KERNING(((FT_Face)face));
}
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Select_1Size(JNIEnv *env, jclass obj, jlong face, jint strikeIndex) {
...
/*
JNIEXPORT jlongArray JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1Kerning(JNIEnv *env, jclass org, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
...
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1KerningX(JNIEnv *env, jclass org, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
	if (FT_Get_Kerning((FT_Face)face, left, right, mode, &vector))
		return 0;
	return vector.x;
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1KerningY(JNIEnv *env, jclass org, jlong face, jchar left, jchar right, jint mode) {
	FT_Vector vector;
	if (FT_Get_Kerning((FT_Face)face, left, right, mode, &vector))
		return 0;
	return vector.y;
...
*/
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1glyph(JNIEnv *env, jclass obj, jlong face) {
	return (jlong)((FT_Face)face)->glyph;
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1GlyphSlot_1Get_1linearHoriAdvance(JNIEnv *env, jclass obj, jlong glyph) {
	return ((FT_GlyphSlot)glyph)->linearHoriAdvance;
}
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1GlyphSlot_1Get_1linearVertAdvance(JNIEnv *env, jclass obj, jlong glyph) {
...
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1GlyphSlot_1Get_1bitmap(JNIEnv *env, jclass obj, jlong glyph) {
	return (jlong)(&((FT_GlyphSlot)glyph)->bitmap);
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1GlyphSlot_1Get_1bitmap_1left(JNIEnv *env, jclass obj, jlong glyph) {
...
JNIEXPORT jlong JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1GlyphSlot_1Get_1metrics(JNIEnv *env, jclass obj, jlong glyph) {
	return (jlong)&((FT_GlyphSlot)glyph)->metrics;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Bitmap_1Get_1width(JNIEnv *env, jclass obj, jlong bitmap) {
	return ((FT_Bitmap*)bitmap)->width;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Bitmap_1Get_1rows(JNIEnv *env, jclass obj, jlong bitmap) {
	return ((FT_Bitmap*)bitmap)->rows;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Bitmap_1Get_1pitch(JNIEnv *env, jclass obj, jlong bitmap) {
	return ((FT_Bitmap*)bitmap)->pitch;
}
JNIEXPORT jshort JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Bitmap_1Get_1num_1grays(JNIEnv *env, jclass obj, jlong bitmap) {
	return ((FT_Bitmap*)bitmap)->num_grays;
}
JNIEXPORT jchar JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Bitmap_1Get_1palette_1mode(JNIEnv *env, jclass obj, jlong bitmap) {
	return ((FT_Bitmap*)bitmap)->palette_mode;
}
JNIEXPORT jchar JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Bitmap_1Get_1pixel_1mode(JNIEnv *env, jclass obj, jlong bitmap) {
...
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1height(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->height;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1horiAdvance(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->horiAdvance;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1vertAdvance(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->vertAdvance;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1horiBearingX(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->horiBearingX;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1horiBearingY(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->horiBearingY;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1vertBearingX(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->vertBearingX;
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Glyph_1Metrics_1Get_1vertBearingY(JNIEnv *env, jclass obj, jlong glyphMetrics) {
	return ((FT_Glyph_Metrics*)glyphMetrics)->vertBearingY;
}
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1CheckTrueTypePatents(JNIEnv *env, jclass obj, jlong face) {
	return FT_Face_CheckTrueTypePatents((FT_Face)face);
}
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1SetUnpatentedHinting(JNIEnv *env, jclass obj, jlong face, jboolean value) {
	return FT_Face_SetUnpatentedHinting((FT_Face)face, value);
}
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Reference_1Face(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jintArray JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Get_1First_1Char(JNIEnv *env, jclass obj, jlong face) {
	FT_ULong  charcode;
	FT_UInt   gindex;
...
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Get_1Next_1Char(JNIEnv *env, jclass obj, jlong face, jlong charcode) {
	FT_UInt   gindex;
...
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Set_1Charmap(JNIEnv *env, jclass obj, jlong face, jlong charmap) {
	return FT_Set_Charmap((FT_Face)face, (FT_CharMap)charmap);
}
JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Get_1Charmap_1Index(JNIEnv *env, jclass obj, jlong charmap) {
	return FT_Get_Charmap_Index((FT_CharMap)charmap);
}
JNIEXPORT jshort JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Get_1FSType_1Flags(JNIEnv *env, jclass obj, jlong face) {
...
JNIEXPORT jboolean JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Palette_1Select(JNIEnv *env, jclass obj, jlong face, jint paletteIndex) {
	FT_Color* palette = NULL;
	FT_Error err = FT_Palette_Select((FT_Face)face, (FT_UShort)paletteIndex, &palette);
	return err == 0;
}

JNIEXPORT jint JNICALL Java_com_mlomb_freetypejni_FreeType_FT_1Face_1Get_1num_1palettes(JNIEnv *env, jclass obj, jlong face) {
	FT_Palette_Data data;
	FT_Error err = FT_Palette_Data_Get((FT_Face)face, &data);
	if (err != 0) return 0;
	return (jint)data.num_palettes;
}
